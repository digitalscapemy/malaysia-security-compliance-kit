...
different framing. All four types below now ship on the same spine.
...
| **Incident / Forensic Report** | Either | Timeline, breach scope, affected data, 72h/7d notification record, remediation | Shipped — `assets/templates/incident-forensic-report.md.tmpl` (see `incident-forensic-report.md`) |
